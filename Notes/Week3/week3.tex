...
\begin{itemize}
    ...
    \begin{enumerate}
        ...
        \begin{itemize}
            ...
            \end{figure}
            \begin{itemize}
                \item These all directly attach an external $\pi$ system to your double bond, and electronegativity pulls electron density out toward these external $\pi$ systems.
            \end{itemize}
        \end{itemize}
    \end{enumerate}
    \item \textbf{S-cis}: Alkenes are \emph{cis} relative to the $\sigma$ bond.
    \item \textbf{S-trans}: Alkenes are \emph{trans} relative to the $\sigma$ bond.
    ...
    \end{figure}
    \begin{itemize}
        \item The reactants are not chiral, but they do have information encoded in their double bonds (e.g., (E)- vs. (Z)-substituents). This information gets translated into whether those substituents are \emph{cis} or \emph{trans} in the product.
    \end{itemize}
    ...
    \item \textbf{Endo} (transition state): A transition state in which bulky groups EWGs on the dienophile lie below the diene.
    \item \textbf{Exo} (transition state): A transition state in which bulky groups EWGs on the dienophile lie away from the diene.
...
\begin{itemize}
    ...
    \begin{figure}[H]
        ...
        \footnotesize
        \schemestart
            \chemname{\chemfig{-[:30](-[2])-[:-30]}}{Isobutane\\}
            \arrow(.20--.180){->[\ce{Cl2}][$h\nu$]}
            \chemname{\chemfig{-[:30](-[2])-[:-30]-[:30]Cl}}{Isobutyl chloride\\(48\%)}
            \+{2em,2em,1.3em}
            \chemname{\chemfig{-[:30](-[:70]Cl)(-[:110])-[:-30]}}{$t$-Butyl chloride\\(29\%)}
            \+
            \chemname{\shortstack{Polychlorinated\\products}}{{\color{white}hi}\\(23\%)}
            \+
            \chemname{\shortstack{HCl\\{\color{white}hi}}}{{\color{white}hi}\\{\color{white}hi}}
        \schemestop
        \chemnameinit{}
