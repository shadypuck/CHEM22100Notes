...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Note that we can have a diene with an EDG at one end, a diene with an EDG in the interior, or a diene with meta EDGs (a so-called \textbf{synergistic eiene} because both EDGs push electrons toward the carbon at the end adjacent to the interior EDG).
    \end{itemize}
