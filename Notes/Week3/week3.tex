...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Alkene reactions to know: hydrogenation (\ce{H2} \ce{Pd}/\ce{C}), dihydroxylation (\ce{OsO4}), ozonolysis (\ce{O3} DMSO), hydrobromination (\ce{HBr}), and bromination (\ce{Br2}).
    \end{itemize}
