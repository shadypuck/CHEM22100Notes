    ...
    \begin{figure}[h!]
        ...
        \begin{tikzpicture}
            ...
            \draw
                ...
                (-2.25,0.1) -- ++(0,-0.2) node[below]{\ce{F}}
                (-1.75,0.1) -- ++(0,-0.2) node[below]{\ce{Cl}}
                (-1.25,0.1) -- ++(0,-0.2) node[below]{\ce{Br}}
                (-0.75,0.1) -- ++(0,-0.2) node[below]{\ce{I}}
...
\begin{itemize}
    ...
    \end{itemize}
    \item Friedel-Crafts acylation.
    \item \textbf{Acetyl group}: The \ce{MeCO} group. \emph{Also known as} \textbf{ethanoyl group}.
    \item \textbf{Benzoyl group}: The \ce{PhCO} group.
    ...
    \item \textbf{Wolf-Kishner reduction}: The basic complement of the Clemmensen reduction, which hydrogenates a ketone with hydrazine (\ce{H2NNH2}), \ce{KOH}, and heat.
