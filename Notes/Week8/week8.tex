...
\begin{itemize}
    ...
    \item \textbf{Dihydroxylation}: The treatment of an alkene with \ce{OsO4} followed by \ce{NaHSO3}, yielding a \emph{cis}-1,2-diol.
    ...
    \begin{figure}[h!]
        ...
        \schemestart
            ...
            \arrow
            \chemfig{@{Cl7}\charge{0=\:,45:1pt=$\ominus$}{Cl}}
            \arrow{0}[,0.5]
        ...
        \caption{Chlorination of an alcohol via the \ce{} mechanism.}
        \label{fig:SOCl2}
    \end{figure}
    \begin{itemize}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item Even in this case, though, we will form a \emph{cis}-product due to the steric bulk of the alcohol group hindering attacks on its face of the molecule.
        \end{itemize}
    \end{itemize}
...
\begin{itemize}
    \item \marginnote{3/7:}\textbf{Alcohol}: A hydroxyl group bonded to a saturated carbon atom.
    ...
    \begin{figure}[h!]
        ...
        \begin{subfigure}[b]{0.32\linewidth}
            \centering
            \chemfig{-[:-30](-[6]OH)-[:30]-[:-30](-[6]C_6H_5)-[:30]}
            \vspace{1em}
    ...
    \end{itemize}
    \item \textbf{Replacement nomenclature}: A method of naming cyclic ethers via relating the compound in question to the corresponding hydrocarbon ring system and using the prefix oxa- to indicate that an oxygen atom replaces a \ce{CH2} group.
    ...
    \begin{itemize}
        \item It is now synthesized industrially by hydrogenating \ce{CO} at high temperatures and pressures.
    ...
    \begin{itemize}
        ...
        \item When the S\textsubscript{N}1 mechanism is active, the leaving of the \ce{H2O} group is the RDS.
    \end{itemize}
    \item \ce{ZnCl2}, a weak Lewis acid, can accelerate the formation of primary alkyl chlorides.
