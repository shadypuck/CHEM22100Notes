...
\begin{itemize}
    ...
    \end{itemize}
    \item \textbf{Replacement nomenclature}: A method of naming cyclic ethers via relating the compound in question to the correspondign hydrocarbon ring system and using the prefix oxa- to indicate that an oxygen atom replaces a \ce{CH2} group.
